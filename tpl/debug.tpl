...
<body>
    ...
    <?php } else { ?>
    <div class="exception">
        <div class="info system-message">
        <h1>:(</h1>
        <span style="font-size: 28px;"><?php echo htmlentities($message); ?></span></div>
    </div>
    <?php } ?>
...
<?php } ?>
    <div class="copyright">
        <a title="官方网站" href="https://www.astrocms.cn/">QHPHP</a> 
        <span>V<?php echo \qhphp\app\App::VERSION; ?></span> 
        <span>{ <?php echo $thinking ?> }</span>
     </div>
    <?php if (APP_DEBUG) { ?>
    <script>
